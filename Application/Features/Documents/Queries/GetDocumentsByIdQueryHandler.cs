...
public class GetDocumentsByIdQueryHandler : IRequestHandler<GetUserByIdQuery, ResponseModel<UserDto>>
{
    private readonly IUserRepository _UserRepository;
    private readonly IErrorHandlingService _errorHandlingService;
    private readonly IMapper _mapper;

    public GetDocumentsByIdQueryHandler(IUserRepository UserRepository, IMapper mapper,
